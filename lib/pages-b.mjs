...
export const shopPage = (store, ctx) => {
  ...
  return {
    ...
    desc: 'Every device in the ' + store.brand + ' store. Pay on delivery and free nationwide shipping.',
    path: '/shop/',
    active: 'shop',
    body: body,
    jsonld: []
...
export const checkoutPage = (store, ctx) => {
  ...
  return {
    ...
    desc: 'Place your order with ' + store.brand + '. Pay on delivery, free nationwide shipping.',
    path: '/checkout/',
    active: 'checkout',
    body: body,
    jsonld: []
...
export const policyPages = (store) => [
  {
    ...
    body: prose('Delivery and returns',
      'We deliver anywhere in Nigeria. Delivery is free on every order, and you pay the rider when the device reaches you.', [
      ...
      ['Paying', ['You pay the rider when the order reaches you. Bank transfer before dispatch also works if you prefer it.']],
  ...
  },
  {
    ...
    body: prose('Payment',
      'You do not pay anything online. Every order is confirmed on the phone first, and you pay when the device reaches you.', [
      ['Pay on delivery', ['You pay the rider when the order arrives.', 'Check the device before you pay, and tell the rider straight away if anything is wrong.']],
      ['Bank transfer', ['If you would rather pay before dispatch, ask us for the account details when we call.', 'We only ever send account details from our own WhatsApp number or over the phone.']],
      ['Card payments', ['Card payment online is coming. Until then, use pay on delivery or a bank transfer.']],
