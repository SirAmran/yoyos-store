...
.brand{display:flex;align-items:center;gap:12px;font-family:var(--font-display);font-weight:800;font-size:20px;letter-spacing:-.03em;flex:none}
.brand .mark{width:44px;height:44px;border-radius:12px;display:block;flex:none}
