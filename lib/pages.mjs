...
export const FAQS = [
  ...
  ['How do I pay?',
   'By bank transfer. Send the order and we confirm the price and the delivery window with you, then we send the account details. Nothing is charged on this site.'],
...
const trustStrip = (store) =>
  ...
  [
    [IC.wallet, 'Pay by bank transfer', 'We confirm your order first, then send the account details.'],
...
export const homePage = (store, ctx) => {
  ...
  const body = '' +
    '<section class="hero"><div class="wrap">' +
      '<div>' +
        ...
        '</div>' +
        '<div class="chips">' +
          '<span>' + svgIc(IC.check) + ' Pay by bank transfer</span>' +
  ...
  return {
    ...
    desc: 'Buy iPhone 17 and 18, iPad, MacBook, Apple Watch, PlayStation 5, AirPods and JBL in Nigeria. Free nationwide shipping, pay by bank transfer, every order confirmed by phone.',
    path: '/',
    active: 'home',
    body: body,
    jsonld: [
...
export const categoryPage = (store, ctx, cat) => {
  ...
  return {
    ...
    desc: cat.blurb + ' Free nationwide shipping from ' + store.brand + '. Pay by bank transfer.',
    path: '/' + cat.id + '/',
    active: cat.id,
    body: body,
    jsonld: [{
    ...
    '<div class="wrap">' +
      '<div class="pdp" id="pdp" data-slug="' + esc(item.slug) + '" data-name="' + esc(item.name) + '"' +
        ...
        '<div class="buy">' +
          ...
          '<div class="buybox">' +
            '<div class="row"><span class="k">' + svgIc(IC.check) + ' Bank transfer</span><span class="v">Nationwide</span></div>' +
