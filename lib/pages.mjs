...
export const homePage = (store, ctx) => {
  ...
  const body = '' +
    '<section class="hero"><div class="wrap">' +
      '<div>' +
        ...
        '<p class="lede">' + esc(store.tagline) + '. iPhone 17, iPad, MacBook, Apple Watch, PlayStation 5, AirPods and JBL. Pick your colour, place the order, and we confirm it on the phone before it ships.</p>' +
        '<div class="cta">' +
  ...
  return {
    ...
    desc: 'Buy iPhone 17, iPad, MacBook, Apple Watch, PlayStation 5, AirPods and JBL in Nigeria. Free nationwide shipping, pay by bank transfer or Paystack, every order confirmed by phone.',
    path: '/',
    active: 'home',
    body: body,
    jsonld: [
