...
export const FAQS = [
  ['Do you deliver outside Lagos?',
   'Yes, we deliver anywhere in Nigeria. Delivery is free, and it takes 3-5 days outside Lagos. We confirm the address on the phone before the order leaves us.'],
  ['How do I pay?',
   'Pay on delivery. You pay the rider when the device reaches you. If you would rather pay before dispatch, a bank transfer works too.'],
...
const trustStrip = (store) =>
  ...
  [
    [IC.wallet, 'Pay on delivery', 'You pay the rider when the device reaches you.'],
    [IC.truck, 'Free nationwide delivery', 'Lagos to your door in 24 hours, ' + store.delivery + '.'],
...
export const homePage = (store, ctx) => {
  ...
  const body = '' +
    '<section class="hero"><div class="wrap">' +
      '<div>' +
        ...
        '<p class="lede">' + esc(store.tagline) + '. iPhone 17 and 18, iPad, MacBook, Apple Watch, PlayStation 5, AirPods and JBL. Pick your colour, place the order, and we confirm it on the phone before it ships.</p>' +
        '<div class="cta">' +
        ...
        '</div>' +
        '<div class="chips">' +
          '<span>' + svgIc(IC.check) + ' Pay on delivery</span>' +
  ...
  return {
    ...
    desc: 'Buy iPhone 17 and 18, iPad, MacBook, Apple Watch, PlayStation 5, AirPods and JBL in Nigeria. Pay on delivery, free nationwide shipping, every order confirmed by phone.',
    path: '/',
    active: 'home',
    body: body,
    jsonld: [
...
export const categoryPage = (store, ctx, cat) => {
  ...
  return {
    ...
    desc: cat.blurb + ' Pay on delivery and free nationwide shipping from ' + store.brand + '.',
    path: '/' + cat.id + '/',
    active: cat.id,
    body: body,
    jsonld: [{
    ...
    '<div class="wrap">' +
      '<div class="pdp" id="pdp" data-slug="' + esc(item.slug) + '" data-name="' + esc(item.name) + '"' +
        ...
        '<div class="buy">' +
          ...
          '<div class="buybox">' +
            '<div class="row"><span class="k">' + svgIc(IC.check) + ' Pay on delivery</span><span class="v">Nationwide</span></div>' +
