...
.ft .brand .mark{border-radius:9px}
...
.ft .addr{display:flex;gap:8px;align-items:flex-start}
.ft .addr svg{width:14px;height:14px;flex:none;margin-top:3px;opacity:.7}
